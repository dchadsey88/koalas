...
def try_me():
    while True:
        val = input("Please give the name of an animal ")
        if val == 'koala':
            print("Yes, that is a koala")
            break
        else:
            print("I am sorry, that it not a koala.  Please try again")
...
if __name__ == '__main__':
    ...
    try_me()
    import koalas
    folder_source, _ = split(koalas.__file__)
